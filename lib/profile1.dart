      ...
      body: ListView(
        children: <Widget>[
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10,),
                Text("Mahoud Alminawi", style: TextStyle(fontSize: 22.0, color: Colors.white),),
                Text("Phillipsburg, Nj", style: TextStyle(fontSize: 14.0, color: Colors.white),)
              ],
            ),
          ),
          Container(
          ...
          ListTile(
            ...
            subtitle: Text("mahmoud@alminwi.com", style: TextStyle(fontSize: 18.0),),
          ),
          Divider(),
          ListTile(
            title: Text("Phone", style: TextStyle(color: Colors.deepOrange, fontSize: 12.0),),
            subtitle: Text("+19083918588", style: TextStyle(fontSize: 18.0),),
          ),
          Divider(),
          ListTile(
            title: Text("Twitter", style: TextStyle(color: Colors.deepOrange, fontSize: 12.0),),
            subtitle: Text("@malminawi", style: TextStyle(fontSize: 18.0),),
          ),
          Divider(),
          ListTile(
            title: Text("Facebook", style: TextStyle(color: Colors.deepOrange, fontSize: 12.0),),
            subtitle: Text("facebook.com/mahoud", style: TextStyle(fontSize: 18.0),),
          ),
          Divider(),
        ],
      ),
